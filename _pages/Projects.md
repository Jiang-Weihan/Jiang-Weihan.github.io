...
<div class="work-board">
  ...
  <input class="work-switch work-switch--game" type="radio" name="work-filter" id="work-game">
  <input class="work-switch work-switch--blogs" type="radio" name="work-filter" id="work-blogs">
  <input class="work-switch work-switch--previous" type="radio" name="work-filter" id="work-previous">

  <div class="work-filter" aria-label="Research and media categories">
    <label class="work-filter__chip work-filter__chip--all" for="work-all">All</label>
    <label class="work-filter__chip work-filter__chip--game" for="work-game">Game Studies</label>
    <label class="work-filter__chip work-filter__chip--blogs" for="work-blogs">Blogs</label>
    <label class="work-filter__chip work-filter__chip--previous" for="work-previous">Previous Research</label>
  </div>
...
<div class="work-list">
  ...
  <article class="work-item work-item--previous">
    <div class="work-item__media work-item__media--text">
      <span>Engineering<br>Projects</span>
    </div>
    <div class="work-item__body">
